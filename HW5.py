...
lab5_raw = '''The quick brown fox jumps over the lazy dog. 
...
(In the rest of this section, we’ll write RE’s in this special style, usually without quotes, and strings to be matched 'in single quotes'.) aoub snaky_snake ChoongaChanga'''

lab5 = lab5_raw.split()

task1 = re.compile(r"ab*")
print(list(filter(task1.match, lab5)))
sep()

task2 = re.compile(r"ab{2}|ab{3}")
print(list(filter(task2.match, lab5)))
sep()

task3 = re.compile(r"[a-z]+_[a-z]+")
print(list(filter(task3.match, lab5)))
sep()

task4 = re.compile(r"[A-Z][a-z]+")
print(list(filter(task4.match, lab5)))
sep()

task5 = re.compile(r"\Aa.*b\b")
print(list(filter(task5.match, lab5)))
sep()

task6 = re.sub(r"[ .,]", ":", lab5_raw)
print(task6)
sep()

task7 = re.sub(r"_([a-z])", lambda snake: snake.group(1).upper(), lab5_raw)
print(task7)
sep()

task8 = re.split(r"[A-Z]", lab5_raw)
print(task8)
sep()

task9 = re.sub(r"([A-Z]\w+)([A-Z]\w+)", lambda this: this.group(1) + " " + this.group(2), lab5_raw)
print(task9)
sep()

task10 = re.sub(r"([a-zA-Z])([A-Z])", r"\1_\2", lab5_raw)
print(task10)
sep()